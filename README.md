...
## Description
Netflix offers its categories according to what the user watches. However there are some secret categories which are not displayed in the navigation menu. This extension enables a new menu with all the hidden categories! =)
